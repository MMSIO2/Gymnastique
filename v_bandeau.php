<div id="menu">
	<dl>
		<dt>Hébergements</dt>
			<dd>
				<ul>
					<a href="index.php?uc=gererHebergementJuges&action=afficherListeHebergement"><li>Voir les Hébergements</li></a>
					<a href="index.php?uc=gererHebergementJuges&action=nouvelHebergement"><li>Ajouter un Hébergement</li></a>		
				</ul>	
			</dd>
	</dl>
